...
export default function RecruitmentPage() {
  ...
  const [ContactInfo, setContactInfo] = useState<ContactInfo | null>(null);
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            await RecruitmentService.ApplyJob(selectedJob?._id, form.fullName, form.email, form.phone, form.address, cvFile);
                            ...
                            <div className="job-list-card">
                                <div className="card h-100">
                                    <div className="card-header blue-bg text-white">
                                        ...
                                        <small className="opacity-75">{jobs.length} jobs found</small>
                                    </div>
                                            ...
                                            {pageJobs.map((job) => (
                                                ...
                                                >
                                                    ...
                                                    <div className="job-meta">
                                                        <span><i className="fas fa-clock me-1"></i>Posted {FormatTime.getRelativeTime(job.createdAt, "en-US")}</span>
                                                        <span><i className="fas fa-briefcase me-1"></i>{job.type}</span>
                                                    </div>
                                        ...
                                        <div className="pagination-container">
                                            ...
                                            <div className="pagination-info text-center">
                                                <small className="text-muted">
                                                    {startIndex + 1} - {Math.min(endIndex, jobs.length)} of {jobs.length} jobs
                                                </small>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="card h-100">
                                        <div className="card-body text-center">
                                            ...
                                            <div className="company-stats mt-4">
                                                <div className="row">
                                                    {Object.entries(ContactInfo?.stats || {}).map(([key, value]) => (
                                                        <div className="col-4" key={key}>
                                                            <div className="stat-item">
                                                                <h5 className="stat-number">{value.number}</h5>
                                    ...
                                    <div className="card h-100">
                                        <div className="card-header">
                                            <div className="d-flex justify-content-between align-items-start">
                                                <div className="flex-grow-1">
                                                    <h4 className="job-title mb-2">{selectedJob.title}</h4>
                                                    <div className="job-meta">
                                                        <span className="badge me-2">{selectedJob.type}</span>
                                                        <small className="text-muted">Posted {FormatTime.getRelativeTime(selectedJob.createdAt, "en-US")}</small>
                                                    </div>
                                                </div>
                                        ...
                                        <div className="card-body">
                                            <div className="job-location mb-4">
                                                <h6>
                                                    <i className="fas fa-map-marker-alt me-2"></i>Work Location
                                                </h6>
                                ...
                                <div className="modal-body">
                                    <form onSubmit={handleSubmit}>
                                        <div className="job-info-display mb-4">
                                            <h6 className="mb-2" style={{color: "rgb(33 77 136)"}}>Applying for:</h6>
                                            <div className="selected-job-info">
                                                <span className="job-title-display fw-bold">{selectedJob?.title}</span>
                                                <span className="job-location-display">{selectedJob?.location}</span>
                                            </div>
                                        </div>
                                        <div className="row">
                                            ...
                                            <div className="col-lg-6 mb-4">
                                                <div className="cv-upload-section">
                                                    <h6 className="mb-3 fw-bold">Upload Your CV/Resume *</h6>
                                                    <div className="cv-upload-area" id="cvUploadArea">
                                                        {!cvFile && (
                                                            <div className="upload-content">
                                                                ...
                                                                <p className="upload-text">Drag and Drop file</p>
                                                            ...
                                                            <div className="file-info" id="fileInfo">
                                                                <div className="file-details">
                                                                    ...
                                                                    <div className="file-text">
                                                                        <span className="file-name" id="fileName">{cvFile.name}</span>
                    ...
                    <div className="row justify-content-center">
                        <div className="col-lg-8 col-md-10 col-12 text-center">
                            ...
                            <p className="text-muted mb-4">
                                {contactHr?.description}
                            </p>
                            <div className="row justify-content-center">
                                <div className="col-md-6 col-sm-6 mb-3">
                                    <div className="contact-info">
                                        <i className="fas fa-envelope" style={{color: "#205b8e"}}></i>
                                        <span>{contactHr?.email}</span>
                                    </div>
                                </div>
                                <div className="col-md-6 col-sm-6 mb-3">
                                    <div className="contact-info">
                                        <i className="fas fa-phone" style={{color: "#205b8e"}}></i>
                            ...
                            <div className="mt-4">
                                <a href="#" className="btn btn-primary btn-lg">
                                    <i className="fas fa-paper-plane me-2"></i>{contactHr?.submitResumeText}
                                </a>
                            </div>
                        </div>
                    </div>
